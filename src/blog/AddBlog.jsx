  ...
  const { user } = useContext(AuthContext);
    ...
    const onSubmit = () => {
        ...
        return (
            ...
            <input type="text" placeholder="Add title" {...register("blogTitle")} ></input>
            </div>
            <div class="form-row">
        <label for="textArea">Blog</label>
        <textarea name="textArea" id="textArea" cols="3" placeholder="Post what is on your mind!!!!" {...register("blogContent")}></textarea>
      </div>
